...
def affine_forward(x, w, b):
  ...
  #            N*D     D*M              1*M
  out = np.dot(x_reshape,w) + b.reshape((1,-1))#b.reshape((1, b.shape[0]))
  # N * M
...
def dropout_forward(x, dropout_param):
    ...
    if mode == 'train':
        ...
        # ================================================================ #
        mask = (np.random.random_sample(x.shape) >= (1-p)) / p
        out = x * mask
        # ================================================================ #
        # END YOUR CODE HERE
        # ================================================================ #
